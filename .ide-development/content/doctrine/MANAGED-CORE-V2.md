...
**Date:** 2026-08-02
**Package version target:** `2.3.1` (identity only; no tag/release claimed by packaging alone — RC archive proof + authorized publication)
...
<repo>/
  .ide-development/                 # committed physical managed package (required)
    VERSION                         # package semver string, e.g. 2.3.1
...
| `packageVersion` | Semver package version (`2.3.1`) |
