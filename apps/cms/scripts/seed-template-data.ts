  ...
  const pages = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          button: { text: 'Go to Contact', href: '/contact', style: 'primary' },
        },
        {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          button: { text: 'Let\'s Work Together', href: '/contact', style: 'primary' },
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          cta: { text: 'Email Us', href: 'mailto:info@example.com', style: 'primary' },
        },
        {
          blockType: 'richText',
          content: {
        ...
        },
        {
          ...
          button: { text: 'Email Us', href: 'mailto:info@example.com', style: 'primary' },
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          button: { text: 'Contact Sales', href: '/contact', style: 'primary' },
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          cta: { text: 'Browse Articles', url: 'ltfx.fix2.url.68d2aae7f712.v1', style: 'primary' },
        },
        {
          blockType: 'richText',
          content: {
      ...
      content: [
        {
          ...
          cta: { text: 'Learn More', href: '/contact', style: 'primary' },
        },
      ],
    },
    {
...
const seedNavigation = async (siteId: string | number, localeCode: string) => {
  ...
  const navItems = [
    ...
    { label: 'Pricing', url: 'ltfx.fix2.url.905d545beba1.v1', order: 2 },
    { label: 'Resources', url: 'ltfx.fix2.url.40ef3c38e9ca.v1', order: 3 },
