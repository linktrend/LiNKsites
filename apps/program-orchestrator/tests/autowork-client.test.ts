...
const requestBase = (): AutoworkRequest => ({ ...pin, requestId: randomUUID(), platform: { orgId: '00000000-0000-0000-0000-000000000001', actorId: 'actor-1', capability: 'sites.precheck', expiresAt: '2026-08-14T00:00:00.000Z', revocationRef: 'lautowork://revocation/active' }, scope: { orgId: '00000000-0000-0000-0000-000000000001', capability: 'sites.precheck', operationKind: 'precheck', scopes: ['precheck'] }, inputRef: { ref: 'linksites://input/1', digest: digest('c'), observedAt: '2026-08-13T00:00:00.000Z' }, correlationRefs: [{ ref: 'linksites://correlation/1', digest: digest('d'), observedAt: '2026-08-13T00:00:00.000Z' }], resultDestinationRef: 'linksites://result/1', idempotencyKey: 'idempotency-1234567890', expiresAt: '2026-08-14T00:00:00.000Z', policy: { sideEffectClass: 'read_only', approvalRequirement: 'none', dataClassification: 'internal' } })
