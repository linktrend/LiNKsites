...
export function validateRuntimeConfig(environment, service) {
  ...
  if (environment.W2_02_MODE && environment.W2_02_MODE !== 'local') errors.push({ name: 'W2_02_MODE', error: 'must remain local until separately authorized runtime migration exists', secret: false })
