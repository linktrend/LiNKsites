# LiNKsites production PRD

Status: pre-configuration engineering baseline complete as of 2026-09-04.

## Product outcome

LiNKsites must operate as an independently buildable and deployable repository. It consumes exact version-pinned shared contracts and communicates with other LiNK repositories only through published interfaces.
