...
1. Phase 1 exact SHA and image/artifact digests have a final independent `PASS`. A missing selectable template blocks only provider-bound activation and the pilot, not foundation installation/acceptance.
