...
- `packages/types/**`
- `README.md`, `docs/LINKSITES-INTENT.md`, `docs/LINKSITES-TECHNICAL-PRD.md`, `docs/LINKSITES-OPERATIONS-MANUAL.md`, `docs/LINKSITES-PRODUCTION-READINESS-ROADMAP.md`, and the append-only current-state clarification in `docs/OPEN-ISSUES.md`
