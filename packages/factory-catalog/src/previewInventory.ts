...
import type { FoundationReservationManager, ReusableSiteFoundation } from './reusableFoundation'
import type { ProspectAdaptation, ProspectAdaptationStatus } from './prospectAdaptation'
