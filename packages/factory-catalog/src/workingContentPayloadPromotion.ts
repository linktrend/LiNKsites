...
import { PromotionService, type PayloadDraftTarget, type PromotionReceipt, type PromotionRequest } from './promotionService'
import type { WorkingContentPromotionInput, WorkingContentRepository } from './workingContent'
