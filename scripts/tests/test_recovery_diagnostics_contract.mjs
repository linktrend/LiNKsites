...
assert.match(rehearsal, /promotionRunMarker\]\[equals\]=\$LINKSITES_LOCAL_PROOF_RUN_MARKER&draft=false&limit=100/)
assert.doesNotMatch(rehearsal, /promotionRunMarker\]\[equals\]=\$LINKSITES_LOCAL_PROOF_RUN_MARKER&draft=true&limit=100/)
