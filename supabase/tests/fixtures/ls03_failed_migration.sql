-- LS-03 failed-migration safety fixture.
-- Executable: invalid SHA-1 identity is attempted and must fail closed.
...
begin
  begin
    ...
    raise exception 'LS-03 invalid SHA-1 identity was accepted';
  exception
  ...
  if exists (
    ...
    raise exception 'LS-03 invalid SHA-1 adoption leaked past the identity check';
  end if;
end
$$;
