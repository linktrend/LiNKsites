 ...
 * Bytes are fixture-owned. They are not provider A1 and not an LS-07 checkpoint.
 */
 ...
 * @param {string | Buffer} params.bytes
 * @param {string} [params.expectedSha256]
 */
...
/**
 * @param {ReturnType<typeof pathsFor>} dirs
 */
...
/**
 * Verify local cache bytes against the active pointer. Tamper fails closed.
 *
 * @param {object} params
 * @param {string} params.cacheRoot
 */
...
/**
 * Mutate cached bytes after materialization so restart must reject them.
 *
 * @param {object} params
 * @param {string} params.cacheRoot
 * @param {string} params.relativePath
